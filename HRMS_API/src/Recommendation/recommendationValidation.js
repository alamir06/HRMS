...
export const recommendationValidationSchema = {
  create: z.object({
    recommendationType: z.enum(['EDUCATION', 'PROFESSIONAL_LICENSE', 'MAYOR_OFFICE', 'MINISTRY_OF_EDUCATION', 'WORK_EXPERIENCE'], {
  ...
  query: z.object({
    ...
    type: z.preprocess(val => val === '' ? undefined : val, z.enum(['EDUCATION', 'PROFESSIONAL_LICENSE', 'MAYOR_OFFICE', 'MINISTRY_OF_EDUCATION', 'WORK_EXPERIENCE']).optional()),
